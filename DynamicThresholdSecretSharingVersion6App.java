...
/**
 * 动态阈值秘密共享系统版本6应用程序 - 严格遵循文档方案
 * 实现4.1-4.6节的所有协议和验证
 */
public class DynamicThresholdSecretSharingVersion6App {
    // ============================ 实验参数配置 ============================
     ...
     * 构造函数：初始化动态阈值秘密共享系统
     */
    public DynamicThresholdSecretSharingVersion6App(int n, int initialThreshold, boolean verbose) {
        this.n = n;
        ...
        public ThresholdTestResult call() {
            ...
            for (int exp = 0; exp < numExperiments; exp++) {
                try {
                    ...
                    // 创建系统实例
                    DynamicThresholdSecretSharingVersion6App system = new DynamicThresholdSecretSharingVersion6App(
